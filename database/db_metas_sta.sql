...
--
-- Host: localhost
-- Tempo de geração: 15/08/2021 às 07:44
...
--
-- Estrutura para tabela `log_metas_fisicas`
--
...
--
-- Fazendo dump de dados para tabela `log_metas_fisicas`
--
...
(1, 1, 220, 'dsdfkj dhkjadh', 0.00, 0, '2021-08-14 10:36:43', '2021-08-14 10:36:43');

-- --------------------------------------------------------

--
-- Estrutura para tabela `log_metas_qualit`
--
...
(1, 1, 1, '2021-08-15 07:40:10'),
(2, 1, 2, '2021-08-15 07:40:10'),
(3, 1, 3, '2021-08-15 07:40:10');
...
(3, 40, 1, 'Acolher os casos de urgência encaminhados pelo Serviço de Atendimento Móvel de Urgência (SAMU), respeitando o perfil epidemiológico e capacidade de atendimento do hospital.', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(4, 40, 1, 'Executar o acolhimento e classificação de risco de 100% (cem por cento) dos pacientes adultos atendidos na unidade de emergência da instituição, segundo protocolo estabelecido para Urgências e Emergências.', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(5, 41, 1, 'Garantir médico traumatologista para desenvolvimento de ambulatório de avaliação cirúrgica para procedimentos eletivos e relacionados a estratégia de aumento do acesso aos Procedimentos Traumato-ortopédicos de Média Complexidade.', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(6, 42, 1, 'Assegurar atenção pós-operatória continuada a todos pacientes que sejamsubmetidos a ações terapêuticas neurointervencionistas e/ou neurocirúrgicasnaunidade', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(7, 43, 1, 'Manter a taxa de suspensão de cirurgias eletivas menor que 8% (oito por cento), exceto aquelas relacionadas ao paciente', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(8, 43, 1, 'Garantir o acesso dos usuários do SUS ao ambulatório para avaliação cirúrgica', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(9, 43, 1, 'Implementar a Sistematização da Assistência de Enfermagem Perioperatória – SAEP', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(10, 44, 1, 'Monitorar e manter atualizados e disponíveis ao gestor do SUS, com periodicidade mensal, os seguintes indicadores: Taxa de ocupação operacional; Taxa de mortalidade absoluta e estimada; Tempo de permanência na Unidade de Terapia Intensiva; Taxa de reinternação em 24 (vinte e quatro) horas; Densidade de Incidência de Pneumonia Associada à Ventilação Mecânica (PAV); Taxa de utilização de ventilação mecânica (VM); Densidade de Incidência de Infecção Primária da Corrente Sanguínea (IPCS) relacionada ao Acesso Vascular Central; Taxa de utilização de cateter venoso central (CVC); Densidade de Incidência de Infecções do Trato Urinário (ITU) relacionada ao cateter vesical.', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(11, 44, 1, 'Manter Taxa de ocupação média mensal da unidade de, no mínimo, 90% (noventa por cento);', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
...
(13, 44, 1, 'Garantir a ocorrência de Lesão por pressão de pacientes internados na UTI menor ou igual a 10% do total de pacientes.', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(14, 45, 1, 'Realizar a confecção da fístula artério venosa de acesso à hemodiálise ou do implante de cateter para diálise peritoneal', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(15, 46, 1, 'Ofertar os exames indicados para o diagnóstico diferencial e definitivo, estadiamento e acompanhamento dos pacientes cadastrados no estabelecimento e, além, ofertar, por demanda e sob regulação do respectivo gestor, exames e consultas especializadas, dentro dos limites dos recursos contratualizados', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(16, 46, 1, 'Realizar o diagnóstico definitivo e a avaliação da extensão da neoplasia (estadiamento), iniciar tempestivamente o tratamento e assegurar a continuidade do atendimento, o pronto atendimento e os cuidados paliativos', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(17, 46, 1, 'Manter atualizados os protocolos clínicos e diretrizes terapêuticas (PCDT) e estabelecer protocolos e condutas institucionais para diagnóstico, estadiamento, tratamento e seguimento dos pacientes com base nas Diretrizes Diagnósticas e Terapêuticas (DDT)', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(18, 46, 1, 'Utilizar e manter atualizados o Sistema de Informação sobre o Câncer (SISCAN - Colo e Mama) e Registro Hospitalar de Câncer (RHC), conforme as normas técnico-operacionais preconizadas pelo Ministério da Saúde,', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(19, 46, 1, 'Registrar o atendimento dos pacientes em prontuário único', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(20, 47, 1, 'Garantir o acesso as medicações necessárias para o processo de pulsoterapia de pacientes crônicos usuários do SUS na quantidade ofertada.', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(21, 48, 1, 'Implementar plano de redução de cesarianas com apresentação bimestral dos resultados alcançados.', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
...
(23, 48, 1, 'Manter frequência de, no mínimo, 50% (cinquenta por cento) dos representantes da instituição nas reuniões dos comitês municipal e estadual de mortalidade materna e infantil.', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(24, 49, 1, 'Garantir o acesso via regulação, de crianças que necessitem de avaliação clínica,internação,cirurgia relacionada à especialidade da traumato/ortopedia,sem necessidade de   valiação inicial no Hospital Regional Norte (HRN) em casos de trauma de extremidades.', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(25, 50, 1, 'Manter 100% (cem por cento) dos leitos visualizados no Sistema de Regulação de Leitos, com garantia de acesso regulado aos Leitos de Internação/internações locais.', 7.70, '2021-08-09 10:24:07', '2021-08-09 10:24:07'),
(26, 45, 1, 'Realizar Tratamento Dialítico em Trânsito', 7.70, '2021-08-09 11:48:05', '2021-08-09 11:48:05'),
(27, 50, 1, 'Garantir tempo resposta do Núcleo Interno de Regulação do hospital à solicitação de regulação dos leitos pela Central de Regulações em até quatro horas.', 7.70, '2021-08-09 11:52:57', '2021-08-09 11:52:57'),
(28, 50, 1, 'Encaminhar 100% (cem por cento) das escalas de Consultas e Exames e alterações previsíveis de agenda profissional até o dia 10 (dez) do mês anterior.', 7.70, '2021-08-09 11:52:57', '2021-08-09 11:52:57'),
(29, 50, 1, 'Confirmar diariamente no Sistema Informatizado de Regulação de Sobral (SISREG-Sobral) e FASTMEDIC as consultas e exames realizados.\r\nImplantar e manter atualizados os protocolos Básicos Segurança do Paciente (Cirurgia segura; Segurança na Prescrição, Uso e Administração de Medicamentos; Prevenção de Quedas).', 7.70, '2021-08-09 11:52:57', '2021-08-09 11:52:57'),
(30, 50, 1, 'Disponibilizar mensalmente os indicadores de acompanhamento dos Protocolos Básicos de Segurança do Paciente (Identificação do Paciente; Prevenção de Úlcera por Pressão; Prática de Higiene das Mãos em Serviços de Saúde).', 7.70, '2021-08-09 11:52:57', '2021-08-09 11:52:57'),
(31, 50, 1, 'Implantar/atualizar protocolos clínico sem 90% (noventa por cento) dos serviços do hospital.', 7.70, '2021-08-09 11:52:57', '2021-08-09 11:52:57'),
(32, 50, 1, 'Realizar 1(uma) reunião mensal dos colegiados de coordenadores de serviço, de gestão clínica e do conselho gestor, com frequência mínima de cinquenta por cento mais 1 dos seus respectivos membros.', 7.70, '2021-08-09 11:52:57', '2021-08-09 11:52:57'),
(33, 50, 1, 'Realizar 1 (uma) reunião bimensal do Colegiado de Gestão Participativa, comparticipação de funcionários do hospital, docentes e discentes  das Instituiçõesde Ensino Superior, assegurando frequência mínima de cinquenta por cento mais 1 dos seus membros.', 7.70, '2021-08-09 11:52:57', '2021-08-09 11:52:57'),
(34, 50, 1, 'Realizar 1 (uma) reunião mensal das Comissões Hospitalares e Gerência de Riscos com frequência mínima de cinquenta por cento mais 1 (um) dos seus membros.', 7.70, '2021-08-09 11:52:57', '2021-08-09 11:52:57'),
(35, 50, 1, 'Realizar, trimestralmente, 1 (uma) reunião da Comissão de Proteção Radiológica com frequência mínima de cinquenta por cento mais 1 de seus membros.', 7.70, '2021-08-09 11:52:57', '2021-08-09 11:52:57'),
(36, 50, 1, 'Manter e qualificar as Comissões Assessoras Obrigatórias pertinentes a instituições hospitalares.', 7.70, '2021-08-09 11:52:57', '2021-08-09 11:52:57'),
(37, 50, 1, 'Avaliar mensalmente amostra de 1% (um por cento) dos prontuários médicos,elaborando relatório descritivo e analítico, incluindo as recomendações necessárias para o seu preenchimento de acordo com a legislação em vigor por parte da equipe multiprofissional, incluindo médicos e enfermeiros residentes e internos de medicina e enfermagem.', 7.70, '2021-08-09 11:52:57', '2021-08-09 11:52:57'),
...
(39, 50, 1, 'Manter programa de Educação Permanente para os profissionais do hospital.', 7.70, '2021-08-09 11:52:57', '2021-08-09 11:52:57'),
...
(54, 50, 1, 'Qualificar os Programas de Residência Médica e Multiprofissional.', 7.70, '2021-08-09 14:12:39', '2021-08-09 14:12:39'),
(55, 50, 1, 'Manter o funcionamento do Departamento de Ensino, Pesquisa e Extensão.', 7.70, '2021-08-09 14:12:39', '2021-08-09 14:12:39'),
(56, 50, 1, 'Manter em funcionamento o Comitê de Ética em Pesquisa com Seres Humanos da SCMS (CEP–SCMS).', 7.70, '2021-08-09 14:12:39', '2021-08-09 14:12:39'),
(57, 50, 1, 'Informar aos Comitês de Ética em Pesquisas locais sobre o início, o andamento e o término das pesquisas desenvolvidas no hospital.', 7.70, '2021-08-09 14:12:39', '2021-08-09 14:12:39'),
(58, 50, 1, 'Ofertar bolsa-auxílio pelo Departamento de Ensino, Pesquisa e Extensão aos estudantes de graduação de instituições de ensino superior (IES) de Sobral.', 7.70, '2021-08-09 14:12:39', '2021-08-09 14:12:39'),
(59, 50, 1, 'Apresentar, anualmente, relatório descritivo e analítico das atividades de extensão desenvolvidas no hospital.', 7.70, '2021-08-09 14:12:39', '2021-08-09 14:12:39'),
(60, 50, 1, 'Manter em funcionamento a Comissão de Residências em Saúde.', 7.70, '2021-08-09 14:12:39', '2021-08-09 14:12:39'),
(61, 50, 1, 'Promover, semestralmente, momentos de interação e integração entre a SCMS e IES conveniadas.', 7.70, '2021-08-09 14:12:39', '2021-08-09 14:12:39'),
(62, 50, 1, 'Manter índices globais de satisfação dos usuários iguais ou superiores a 70% (setenta por cento) no serviço de emergência, e de 80% (oitenta por cento) nos demais serviços.', 7.70, '2021-08-09 14:12:39', '2021-08-09 14:12:39'),
(63, 50, 1, 'Monitorar, avaliar e disponibilizar mensalmente os indicadores de taxa de ocupação de leitos, tempo médio de permanência para leitos de clínica médica e cirúrgica e taxa de mortalidade institucional.', 7.70, '2021-08-09 14:12:39', '2021-08-09 14:12:39'),
(64, 50, 1, 'Monitorar, avaliar e disponibilizar mensalmente os indicadores relacionados aos componentes da Rede Cegonha: Taxa de óbitos infantis (neonatal e pós-neonatal). Numero absoluto de óbitos maternos;  Nas- cidos vivos segundo idade da mãe, segundo IG (< 37 semanas); Tipo de parto: % de partos cesáreos e partos normais.', 7.70, '2021-08-09 14:12:39', '2021-08-09 14:12:39'),
(65, 50, 1, 'Monitorar, avaliar e disponibilizar mensalmente os indicadores relacionados aos componentes da Rede de Urgência e Emergência: taxa de morbimortalidade, incidência de causas externas (considerando taxa de acidentes automobilísticos, agressão física, entre outros), tempo de permanência e tempo de internação.', 7.70, '2021-08-09 14:12:39', '2021-08-09 14:12:39');
...
--
-- Índices de tabela `log_metas_fisicas`
--
...
--
-- Índices de tabela `log_metas_qualit`
--
...
--
-- AUTO_INCREMENT de tabela `log_metas_fisicas`
--
ALTER TABLE `log_metas_fisicas`
  MODIFY `CD_LOG_METAS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `log_metas_qualit`
--
ALTER TABLE `log_metas_qualit`
